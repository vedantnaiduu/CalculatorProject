...
public class Main {
	...
	public static void startCalc(){
		...
		if (s.equalsIgnoreCase("quit")) {  // credit: Pranav S. helped me with this part
	...
	public static String calculate(String s){
		...
		if (answer2.hasNextInt()|| answer2.hasNextDouble() ) {
	...
	public static String OneOP(Scanner answer2,String symbol,double num1,double num2) {
		...
		String result="";
		if (!(symbol.equals("v")||symbol.equals("|")|| symbol.equals("sin") || symbol.equals("cos") || symbol.equals("tan") )) {
		String j ="error";
		result=j;
		}
		if (symbol.equals("v")){
